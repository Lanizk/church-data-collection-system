...
<div class="page-header mb-4">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h3 class="page-title mb-2">Add Administrator</h3>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-bottom py-3">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h5 class="mb-1 fw-bold">Administrator Registration Form</h5>
                <p class="text-muted mb-0 small">Please fill in all required information to add a new administrator</p>
            </div>
        </div>
    </div>
    
    <div class="card-body p-4">
        <form method="POST" action="/admin/admin/add" id="adminForm">
            @csrf
            ...
            <div class="mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Enter the administrator's full legal name</small>
                    </div>
            ...
            <div class="alert alert-info border-0 d-flex align-items-start" role="alert">
                ...
                <div>
                    <strong>Important:</strong> The new administrator will receive login credentials via email. 
